                         ...
                         <div className="lg:pt-20">
                              <div className="max-w-2xl mx-auto text-center mb-10">
                                   ...
                                   <p className="mt-2 lg:text-lg text-gray-300">
                                        Whatever your status, our offers evolve
                              ...
                              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:items-center">
                                   {plans.map((plan, index) => (
                                        <div
                                             ...
                                             className={`flex flex-col rounded-2xl p-6 md:p-8 transition-all duration-300 cursor-pointer h-full ${
                                                  selectedPlan === index
                                   ...
                                   <ul
                                        ...
                                        {feature.availability.map(
                                             (isAvailable, index) => (
                                                  <li
                                                       key={index}
                                                       className="col-span-2 py-1.5 lg:py-3">
                                                       <div className="grid grid-cols-2 md:grid-cols-6 lg:block">
                                                            {isAvailable ? (
                                                                 <i className="ri-check-line ri-lg" />
                                                            ) : (
                                                                 ""
                                                            )}
                                                       </div>
                    ...
                    <div className="max-w-3xl mx-auto grid grid-cols-3 gap-6">
                         ...
                         <div className="col-span-2">
                              ...
                              <h3 className="text-xs p-1 border border-slate-700 mt-2 rounded-md">
                                   By subscribing, you agree to our Purchaser
                                   Terms of Service. Subscriptions auto-renew
                                   until canceled. Cancel anytime, at least 24
                                   hours prior to renewal to avoid additional
                                   charges. Manage your subscription through the
